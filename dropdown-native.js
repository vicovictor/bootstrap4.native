...
// original by dnp_theme
// modified by victorngkp
...
var Dropdown = function( element) {
  ...
  this.toggle = function(e) {
    if (/\bshow/.test(this.menu.parentNode.className)) {
      this.close();
      document.removeEventListener('keydown', this.key, false);
    } else {
      this.menu.parentNode.className += ' show';
  ...
  this.close = function() {
    self.menu.parentNode.className = self.menu.parentNode.className.replace(/\bshow/,'');
